...
3rolls = URI.open('https://spice-aa-seeds.s3.us-east-2.amazonaws.com/sushi/3rolls.jpg')
...
s2.photos.attach(io: 3rolls, filename: '3rolls.jpg')
...
s5.photos.attach(io: sushiplatter, 'sushiplatter.jpg')
s5.photos.attach(io: sushirolls3, 'sushirolls3.jpg')
s5.photos.attach(io: sushirolls2, 'sushirolls2.jpg')
