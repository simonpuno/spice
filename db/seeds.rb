...
b1r1 = Review.create!(content: 'Great place!', rating: 5, user_id: u1.id, business_id: b1.id)
b1r2 = Review.create!(content: 'Decent place!', rating: 3, user_id: u2.id, business_id: b1.id)
b1r3 = Review.create!(content: 'Terrible place!', rating: 1, user_id: u3.id, business_id: b1.id)
b1r4 = Review.create!(content: 'Spicy place!', rating: 5, user_id: u4.id, business_id: b1.id)
b1r5 = Review.create!(content: 'Mild place!', rating: 3, user_id: u5.id, business_id: b1.id)
